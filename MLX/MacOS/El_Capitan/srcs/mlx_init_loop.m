...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/11 00:00:25 by bfleury           #+#    #+#             */
/*   Updated: 2016/11/11 00:00:31 by bfleury          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/mlx.h"
#include "../includes/mlx_new_window.h"
#include "../includes/mlx.font"
...
int		mlx_pixel_put(mlx_t *mlx_ptr, mlx_win_list_t *win_ptr, int x, int y, int color)
{
	if (!win_ptr->pixmgt)
		return (0);
...
int		mlx_loop_hook(mlx_t *mlx_ptr, void (*fct)(void *), void *param)
{
