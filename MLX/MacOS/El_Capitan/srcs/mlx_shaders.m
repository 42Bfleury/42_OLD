...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/11 00:07:16 by bfleury           #+#    #+#             */
/*   Updated: 2016/11/11 00:07:46 by bfleury          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		mlx_shaders(glsl_info_t *glsl)
{
	...
	result = mlx_shaders_font(glsl);
	result += mlx_shaders_image(glsl);
	result += mlx_shaders_pixel(glsl);
	return (i);
}
