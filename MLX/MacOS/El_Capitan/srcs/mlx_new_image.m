...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/11 00:09:34 by bfleury           #+#    #+#             */
/*   Updated: 2016/11/11 00:09:43 by bfleury          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
mlx_img_ctx_t	*add_img_to_ctx(mlx_img_list_t *img, mlx_win_list_t *win)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, img->width, img->height, 0, GL_BGRA, GL_UNSIGNED_BYTE, img->buffer);
...
int				mlx_put_string(mlx_ptr_t *mlx_ptr, mlx_win_list_t *win_ptr, int x, int y, int color, unsigned char *string)
{
	mlx_img_ctx_t	*imgctx;
	int				gX;
	int				gY;
